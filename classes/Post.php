...
class Post {
        ...
        public static function createPost($postbody, $loggedInUserId, $profileUserId,$isAdmin) {
        ...
        public static function createImgPost($postbody, $loggedInUserId, $profileUserId,$isAdmin) {
